...
class Article extends Component{
  ...
  render() {
       return (
         <div key={this.state.article.id} className={`Article ${this.state.menu}`} onClick={this.toggleMenu}>
         <Header hidden={this.state.menu}/>
         <ProgressBar menuHidden={this.state.menu}/>
         <div
